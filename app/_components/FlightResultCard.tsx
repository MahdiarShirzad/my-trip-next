...
export default function FlightResultCard({ flight }: FlightResultCardProps) {
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl dark:border-slate-800 dark:bg-slate-900 dark:hover:border-[#7167FF]/40 sm:flex-row">
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="absolute left-[234px] top-1/2 hidden h-4 w-4 -translate-y-1/2 rounded-full bg-slate-50 dark:bg-slate-950 sm:block"
      />
